...
class _StudendAddState extends State with StudentValidationMixin {
  ...
  Widget builPuanField() {
    return Container(
      ...
      child: TextFormField(
        ...
        onSaved: (String? value){
          if(value != null){
            student_.point = int.parse(value);
          }
        },
      ),
    );
  ...
  void saveStudent() {
    print(student_.fitstName);
    print(student_.lastName);
    print(student_.point);
  }
}